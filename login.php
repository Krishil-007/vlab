...
<head>
    ...
    <link rel="stylesheet" href="./style_alert.css?v=<?php echo time(); ?>">
</head>
...
<img class="nirmaLogo" src="nirma.png" alt="">
    <h1>Welcome to Nirma University VLAB</h1>
        ...
        <div class="login slide-up">
            <div class="center">
				...
				margin: 1rem;">
                    ...
                    $rediectUrl = 'http://localhost:8080/CAT_Innovative/UI.html';
...
if (isset($_POST['logIn'])) {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($email) || empty($pass)) {
            ...
            if ($num == 0) {
                ...
                if (strcmp($pass, $row["Password"]) == 0) {
                    header("Location: http://localhost:8080/CAT_Innovative/UI.html");
                } else {
        ...
        if (strcmp($err, "")) {
            echo '<div style="position: absolute;top: 1rem;" class="alert error">
...
if (isset($_POST['signUp'])) {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (strcmp($succ, "")) {
            echo '<div style="position: absolute;top: 1rem;" class="alert success">
